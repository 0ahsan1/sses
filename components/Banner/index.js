...
export function HeroBanner({ data }) {
	return (
		<div className="relative dark:bg-white bg-gray-900">
			<div className="mx-auto max-w-full lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
				<div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-48 lg:pt-40 xl:col-span-6">
					<div className="mx-auto max-w-xl lg:mx-0">
						<h1 className="mt-24 text-pretty text-5xl font-semibold tracking-tight dark:text-gray-900 sm:mt-10 sm:text-7xl text-white">
							{data?.title}
						</h1>
						<p className="mt-8 text-pretty text-lg font-medium dark:text-gray-500 sm:text-xl/8 text-gray-400" dangerouslySetInnerHTML={{ __html: data?.description }} />
