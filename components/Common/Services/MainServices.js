								...
								<CardContent className="p-8">
									...
									<div className="mt-8 pt-6 border-t border-gray-200">
										<div className="flex justify-between items-center">
											<div>
												<h4 className="font-bold text-lg text-gray-900">Ready to get
													started?</h4>
												<p className="text-gray-600">Get a customized quote for
													your {service.title.toLowerCase()}</p>
											</div>
