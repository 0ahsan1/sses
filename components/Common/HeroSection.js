...
export default function HeroSection() {
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1509391366360-2e959784a276?w=1920')] bg-cover bg-center opacity-20" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
            ...
            <br />Best prices in Pakistan. Zero down payment options available.
          </p>
