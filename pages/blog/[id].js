                    ...
                    <div className="blog-details-wrap">
                      ...
                      <div className="blog-details-content">
                        ...
                        <p>
                          ...
                          looking at it as layout. The point of using Lorem
                          Ipsum is that it has a more normal
                          distribution.Collaboratively pontificat bleed aedge
                          resources with inexpensive methodologies globally
                          initiate multidisciplinary compatible architectures as
                          our aspiteously repurpose leading edge growth
                          strategies
                        </p>
                        <blockquote>
                          <p>
                            Which Podcasts Should Web Designer And Developers Be
                            Listening To Ultimate Digital Clean our Checklist
                            Prepare eadable when content of a page when looking
                            at its layout.
                          </p>
                        ...
                        <p>
                          ...
                          distracted by the readable content of a page when
                          looking at it as layout. The point of using Lorem
                          Ipsum is that it has a more normal distribution.
                        </p>
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              <div className="bd-inner-content">
                                <p>
                                  The point of using Lorm Ipsum is that it has a
                                  our more normal our distribution
                                  Collaboratively pontificat bleed edge as
                                  resources with inexpensive thje methodologie
                                  sglobally initiate multidisciplinary.
                                </p>
                                <ul className="list-wrap">
                                  <li>
                                    <i className="fas fa-check-circle" />
                                    Information Tecaccumulation of technologies
                                  </li>
                                  <li>
                                    <i className="fas fa-check-circle" />
                                    Autonomous house with its garden and office
                                  </li>
                                  <li>
                                    <i className="fas fa-check-circle" />
                        ...
                        <p>
                          ...
                          in a our some form, by injected humour, or randomised
                          words which don't look even slightly believable. If
                          you are going our as to use a passage of Lorem Ipsum,
                          you need to be sure there isn't anything embarrassing
                          hidden in the middle the of text. All the Lorem Ipsum
                            ...
                            <div className="col-lg-8">
                              <div className="post-tags">
                                ...
                                <ul className="list-wrap">
                                  ...
                                  <li>
                                    <Link href="#">#Roofing Service</Link>
                                  </li>
                                  <li>
                              ...
                              <div className="post-inner">
                                <div className="thumb">
                                  <Link href="/blog-details">
                                    <img
                                      src="/assets/img/blog/pb_post_img01.jpg"
                                      alt=""
                                    />
                                  </Link>
                                </div>
                                <div className="content">
                                  <h2 className="title">
                                    <Link href="/blog-details">
                                      Portrait smiling professional engineer
                                      laptop
                                    </Link>
                                  </h2>
                                  <span>
                                    <i className="far fa-calendar-alt" />
                                    22 Jan {new Date().getFullYear()}
                                  </span>
                                </div>
                              </div>
                            ...
                            <div className="post-item next-post-item">
                              <div className="post-inner">
                                <div className="thumb">
                                  <Link href="/blog-details">
                                    <img
                                      src="/assets/img/blog/pb_post_img02.jpg"
                                      alt=""
                                    />
                                  </Link>
                                </div>
                          ...
                          <ul className="list-wrap">
                              ...
                              <div className="comments-box">
                                ...
                                <div className="comments-text">
                                  <div className="avatar-name">
                                    ...
                                    <span className="date">
                                      September 6, {new Date().getFullYear()}
                                    </span>
                                  </div>
                                  <p>
                                    Lorem ipsum dolor sit amet consectetur. Ut
                                    tellus suspendisse nulla aliquam. Risus
                                    rutrum tellus ultrices.
                                  </p>
                                </div>
                              </div>
                                  ...
                                  <div className="comments-box">
                                    ...
                                    <div className="comments-text">
                                      ...
                                      <p>
                                        ...
                                        Ut tellus suspendisse nulla aliquam.
                                        Risus rutrum tellus ultrices.
                                      </p>
                                    </div>
                                  </div>
                                </li>
                            ...
                            <li>
                              <div className="comments-box">
                                <div className="comments-avatar">
                                  <img
                                    src="/assets/img/blog/comment_avatar03.png"
                                    alt=""
                                  />
                                </div>
                                <div className="comments-text">
                            ...
                            <li>
                              <div className="comments-box">
                                <div className="comments-avatar">
                                  <img
                                    src="/assets/img/blog/comment_avatar04.png"
                                    alt=""
                                  />
                                </div>
                                <div className="comments-text">
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-10">
                    <aside className="blog-sidebar">
                      ...
                      <div
                        ...
                        data-background="/assets/img/blog/widget_bg.jpg"
                        style={{
                          backgroundImage:
                            'url("/assets/img/blog/widget_bg.jpg")',
                        }}
                      >
                        ...
                        <div className="sidebar-content">
                          ...
                          <p>
                            Sit amet consectetur adipiscing elseds do eius mod
                            tempor incididunt
                          </p>
