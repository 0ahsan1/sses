                                        ...
                                        <div className="accordion-item">
                                            ...
                                            <div className={isActive.key == 1 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>A solar powered energy system consists of solar panels, inverter, mounting structure for solar panels, electrical wiring, breakers and sometime batteries. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            ...
                                            <div className={isActive.key == 2 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>Photovoltaic (PV) cells in solar panels convert sunlight into direct current (DC). Inverters then convert the DC electricity into the alternating current (AC) which is then transferred to the main electrical distribution panel (DB) for use. In off-grid and hybrid systems, batteries can be used for storing the initial DC electricity coming from the solar panels through a charge controller.</p>
                                                </div>
                                            </div>
                                        </div>
                                        {/* <div className="accordion-item">
                                    ...
                                    <p>• Load is located around the area which is subjected to frequent load shedding.</p>
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            <div className={isActive.key == 6 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>The only kind of maintenance a solar powered energy system requires is the cleaning of solar panel itself and nothing else. The frequency of cleaning can be weekly or bi-monthly according to the site situation. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 7 ? "accordion-button" : "accordion-button collapsed "}>
                                                    How much space would I need to install my solar powered system?                                            </button>
                                            </h2>
                                            <div className={isActive.key == 7 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>Space requirements range from 100 to 130 square feet per kW of solar PV installed, depending the tilt angle of the solar PV modules and facing towards the path that sun follows in that region. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 8 ? "accordion-button" : "accordion-button collapsed "}>
                                                    What if my system produces more energy than I require?                                            </button>
                                            </h2>
                                            <div className={isActive.key == 8 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>The excess electricity would either be sold back to the grid using the net metering or will be stored in the form of batteries and used later by the same load center. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 9 ? "accordion-button" : "accordion-button collapsed "}>
                                                    Will the weight of the solar PV system be of any concern for my roof?                                            </button>
                                            </h2>
                                            <div className={isActive.key == 9 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>Concrete roofs have no problems at all in handling the distributed load nature of solar PV panels and its frames, however T-slabs & truss based roofs have to be analyzed first before they are used for installation. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 10 ? "accordion-button" : "accordion-button collapsed "}>
                                                    How long does a solar powered energy system last?                                            </button>
                                            </h2>
                                            <div className={isActive.key == 10 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>Our systems are designed to have a useful life of 25 years or much more, according to the climate and atmosphere it has been used it. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 11 ? "accordion-button" : "accordion-button collapsed "}>
                                                    Does SSES provide O&M services?                                                                                   </button>
                                            </h2>
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            <div className={isActive.key == 13 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>SSES was started by the first ever Energy Engineers of Pakistan. We are here to elevate the standards of services in the solar field. SSES has successfully installed hundreds of solar projects with unbeatable price and services within Pakistan. We strive to live by the following codes of ethic.</p>
                                                    ...
                                                    <p>• Safety of client and labor always comes first. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 14 ? "accordion-button" : "accordion-button collapsed "}>
                                                    What is the point of origin of SSES’s products?                                               </button>
                                            </h2>
                                            <div className={isActive.key == 14 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>SSES sources its components from various countries. Some of these countries include Germany, Austria, Italy, United States, China and Pakistan. SSES focuses its efforts on designing the most optimum technical and commercial solution on a case to case basis. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 15 ? "accordion-button" : "accordion-button collapsed "}>
                                                    How to check if the components offered are off the best quality or not?                                              </button>
                                            </h2>
                                            <div className={isActive.key == 15 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>There is nothing hidden during these times of information available at hand.  Nowadays market is full of deceit. We give our costumer the virtual choices they can select from according to their requirement and need after they choose and the goods are delivered, they can scan the QR codes of those equipment to cross check what they had chosen earlier.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="accordion-item">
                                        ...
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" onClick={() => handleToggle(5)}>
                                                <button className={isActive.key == 17 ? "accordion-button" : "accordion-button collapsed "}>
                                                    How much would a solar powered system installed by SSES cost?                                              </button>
                                            </h2>
                                            <div className={isActive.key == 17 ? "accordion-collapse collapse  show" : "accordion-collapse collapse "}>
                                                <div className="accordion-body">
                                                    <p>SSES can provide the best information on what it will cost to go solar for your load. However, once customers begin to explore solar options, they can find vastly varying rates in the market for the same system, what differ are the genuine parts and equipment used by us and some local street vendors.  Moreover it is important for costumers to know that the total up-front cost of solar is less relevant than the financing terms, return-on-investment, and cash flow calculation. Financial options such as solar leases and other innovative financing models can help you convert to solar for little or no money along with an efficient design that can also help bring the costs down.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
